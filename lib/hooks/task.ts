...
export function useCheckTask(args: { operation: PolicyCrudKind; where?: { id?: string; title?: string; description?: string; spaceId?: string; ownerId?: string }; }, options?: QueryOptions<boolean>) {
